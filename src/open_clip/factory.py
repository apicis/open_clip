...
from .loss import ClipLoss, DistillClipLoss, CoCaLoss, SigLipLoss, PositiveNegativeCoCaLoss, TripletCoCaLoss
...
def create_loss(args):
    if args.distill:
        ...
        if args.coca_negative_loss_weight == 0 and args.coca_triplet_loss_weight == 0:
            ...
            if args.coca_negative_loss_weight != 0 and args.coca_negative_loss_weight != 0:
                pass
            elif args.coca_negative_loss_weight != 0:
                return PositiveNegativeCoCaLoss(
                    caption_loss_weight=args.coca_caption_loss_weight,
                    clip_loss_weight=args.coca_contrastive_loss_weight,
                    negative_loss_weight=args.coca_negative_loss_weight,
                    local_loss=args.local_loss,
                    gather_with_grad=args.gather_with_grad,
                    cache_labels=True,
                    rank=args.rank,
            ...
            elif args.coca_triplet_loss_weight != 0:
                return TripletCoCaLoss(
                    caption_loss_weight=args.coca_caption_loss_weight,
                    clip_loss_weight=args.coca_contrastive_loss_weight,
                    triplet_loss_weight=args.coca_triplet_loss_weight,
                    local_loss=args.local_loss,
                    gather_with_grad=args.gather_with_grad,
                    cache_labels=True,
                    rank=args.rank,
